...
function ServicesList({ services }: { services: IFireComplaint["services"] }) {
  return (
...
function AnswerItem({ answer }: { answer: IFireAnswers }) {
  const actionBadges = [
    {
...
function QuestionsList({
  ...
  questions: IFireComplaint["questions"];
}) {
...
function DeterminantsList({
  ...
  determinants: IFireComplaint["determinants"];
}) {
              ...
              >
                <div className="flex justify-between items-center gap-2">
                  ...
                  <Badge className="text-xs bg-gray-100 text-gray-800">
                    Response:{" "}
                    {getFireResponsePlan(code.recResponse)?.incidentType}
                  </Badge>
                </div>
                          ...
                          >
                            ...
                            {subCode.recResponse && (
                              <Badge className="text-xs">
                                Response:{" "}
                                {
                                  getFireResponsePlan(subCode.recResponse)
                                    ?.incidentType
                                }
                              </Badge>
                            )}
...
function ProtocolCard({ protocol }: { protocol: IFireComplaint }) {
